...
<head>
    ...
    <title>Konfirmasi Kata Sandi - Holliday Group</title>
...
<body class="bg-[#F8F7F4] text-[#18181B] antialiased min-h-screen flex flex-col justify-center items-center px-4 py-12 selection:bg-[#B86B1B] selection:text-white">
    ...
    <div class="w-full max-w-md mx-auto">
        ...
        <!-- KARTU TUNGGAL KONFIRMASI PASSWORD -->
        <div class="bg-white p-8 rounded-2xl border border-[#EBEAE5] shadow-xs">
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="space-y-4">
                ...
                <!-- Password Input -->
                <div>
                    <x-input-label for="password" :value="__('Kata Sandi')" class="!text-xs !font-bold !text-[#18181B] uppercase tracking-wider mb-1.5" />
        ...
        <div class="mt-6 text-center">
            <a href="{{ url()->previous() }}" class="inline-flex items-center gap-2 text-xs text-[#71717A] hover:text-[#18181B] font-medium transition-colors">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
                <span>Kembali Halaman Sebelumnya</span>
            </a>
        </div>
